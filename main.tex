...
using detailed models in two distinct regimes: cluster formation in giant molecular clouds (led by co-PI Wall), and
star formation histories of low mass dwarf galaxies (led by co-PI Emerick). 
