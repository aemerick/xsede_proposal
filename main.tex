...
This renewal proposal describes our proposed research for the coming in in two related areas of astrophysical research. The PI of this proposal (M-M. Mac Low) is PI on {\rm grant / NSF grant info}, co-PI Emerick is supported by a NSF Graduate Research Fellowship, and co-PI Wall is {\rm grant}. Our research focuses in understanding the detailed effects of feedback physics using detailed models in two distinct regimes: giant molecular clouds (lead by co-PI Wall), and low mass dwarf galaxies (lead by co-PI Emerick). Both projects represent unique and novel endeavors in their respective sub-fields. The GMC simulations combine direct N-body dynamics, stellar evolution, and detailed feedback together in a hydrodynamics simulation. Our dwarf galaxy simulations combine detailed feedback following individual stars -- unique on galaxy scales -- while tracking stellar yields to trace both gas and stellar phase abundances for a dozen distinct metal species. Each project is supervised by PI M-M. Mac Low, with collaborator G. Bryan co-advising the dwarf galaxy project. We summarize the science motivation for each of these projects below, while justifying our resource request. We note each project is central to the PhD thesis for both co-PI Wall (GMC's) and co-PI Emerick (dwarf galaxies).
